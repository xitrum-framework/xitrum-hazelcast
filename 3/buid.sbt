...
libraryDependencies += "tv.cntt" %% "xitrum" % "2.12" % "provided"

libraryDependencies += "com.hazelcast" % "hazelcast" % "3.1.3"

libraryDependencies += "com.hazelcast" % "hazelcast-client" % "3.1.3"
